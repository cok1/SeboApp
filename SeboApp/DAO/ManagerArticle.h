...
public:
	...
	/// <returns>true si l'ajout a été réalisé, false sinon.</returns>
	static bool addArticle(QString libelle, double prixVenteHT, QString photo, QString description, int idGenre, double prixFournisseur, int idFournisseur, bool isReapprovisionnable);
